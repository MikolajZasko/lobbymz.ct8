...
$(document).ready(function () {
    ...
    // ally plscement
    let allyManager = new AllyManager()
    for (let i = 0; i < 10; i++) {

        let x = Math.round((-150) + Math.random() * (150 + 150))
        let z = Math.round((-150) + Math.random() * (150 + 150))

        // console.log("new");
        // console.log(x);
        // console.log(z);

        allyManager.newAlly(x, 0, z, i, scene)
    ...
    window.addEventListener("mousedown", (e) => {
        ...
        if (intersects.length > 0) {
            ...
            if (hitObject.name == "ally") {

                hitObject.following = true
    ...
    window.addEventListener("mousemove", (e) => {
        ...
        if (intersects.length > 0) {
            ...
            let hitObjectAlly = intersects[0].object.parent.children[0]
            ...
            // ally on hover
            else if (hitObjectAlly.name == "ally") {
                // console.log("ally");
            }
